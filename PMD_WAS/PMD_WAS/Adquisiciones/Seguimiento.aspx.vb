...
Public Class Seguimiento
    ...
    Protected Sub lnk_Command(sender As Object, e As CommandEventArgs)
        ...
        Try
            ...
            If e.CommandName = "imprimir" Then
                ...
                Dim url = helper.RegresaFormatoRequisicion(folio)
            ...
            ElseIf e.CommandName = "materiales" Then
                ...
                Using data As New DB(con.conectar())
                    ...
                    Dim dt = data.ObtieneDatos("ObtieneDetalleRequisicion", params).Tables(0)
