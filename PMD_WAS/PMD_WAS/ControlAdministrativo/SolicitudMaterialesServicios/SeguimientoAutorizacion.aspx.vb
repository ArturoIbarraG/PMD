...
Public Class SeguimientoAutorizacion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If Session("Puesto") <> "4" Then
                Response.Redirect("~/ControlAdministrativo/SolicitudMaterialesServicios/OrdenesSurtido.aspx")
            End If
    ...
    Private Sub CargaGrid()
        Using data As New DB(con.Conectar())
            ...
            Session("SolicitudeOrdenesAbastecimiento") = data.ObtieneDatos("ObtieneOrdenesSurtido", params).Tables(0)
            grdSolicitudes.DataSource = Session("SolicitudeOrdenesAbastecimiento")
    ...
    Protected Sub btnRechazarSolicitud_Click(sender As Object, e As EventArgs)
        Try
            ...
            Else
                Dim engine As New IntelipolisEngine.PMD.OrdenAbastecimiento()
                engine.RechazaOrdenAbastecimiento(solicitudes, ddlMotivoRechazo.SelectedValue, Session("Clave_empl"), txtComentariosRechazo.Text)
    ...
    Protected Sub btnAutorizarOrdenesSurtido_Click(sender As Object, e As EventArgs)
        Try
            Dim solicitudes As New List(Of Integer)
            For Each row As GridViewRow In grdSolicitudes.Rows
                Dim checkbox = DirectCast(row.FindControl("chkSeleccionar"), CheckBox)
            ...
            Else
                Dim engine As New IntelipolisEngine.PMD.OrdenAbastecimiento()
                engine.AutorizarOrdenAbastecimiento(solicitudes, Session("Clave_empl"))
    ...
    Protected Sub chkTodos_CheckedChanged(sender As Object, e As EventArgs)
        Dim dt = DirectCast(Session("SolicitudeOrdenesAbastecimiento"), DataTable)
        ...
        Session("SolicitudeOrdenesAbastecimiento") = dt
    End Sub
End Class