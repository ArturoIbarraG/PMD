<%@ Page Language="VB" AutoEventWireup="false" Title="Requerimientos" MasterPageFile="~/MasterPage/MasterNuevaImagen.master"
    Inherits="PMD_WAS.RequerimientosDirector" Codebehind="RequerimientosDirector.aspx.vb" %>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <asp:Panel ID="Panel1" runat="server">
                                        <h6 class="subtitle">Descripción</h2>
                                        <b>
