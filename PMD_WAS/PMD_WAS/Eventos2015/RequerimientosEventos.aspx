<%@ Page Language="VB" AutoEventWireup="false" Title="Requerimientos" MasterPageFile="~/MasterPage/MasterNuevaImagen.master"
    Inherits="PMD_WAS.RequerimientosEventos" Codebehind="RequerimientosEventos.aspx.vb" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdRequerimientos" runat="server" CssClass="table table-hover table-bordered" Width="100%" Height="90px" CellPadding="4" ClientIDMode="Static" EmptyDataText="No hay información que mostrar." OnRowDataBound="grdRequerimientos_RowDataBound"
                                            ForeColor="#333333" GridLines="None" TabIndex="6" AutoGenerateColumns="false">
                                            <Columns>
                                                <asp:BoundField HeaderText="Tipo" DataField="TipoNombre" />
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <asp:Button ID="btnCancelar" CssClass="btn btn-secondary right" runat="server" Text="Cancelar" Visible="false"
                            TabIndex="13" />
    ...
    <script type="text/javascript">
        ...
        function muestraMensajePresupuestoMayor(contrato) {
            swal({
                type: 'info',
                text: 'El presupuesto comprometido de el contrato ' + contrato + ' ha sido sobrepasado, favor de validar.',
