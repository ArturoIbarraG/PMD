...
Imports conexion
Partial Class RequerimientosEventos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack = True Then
            ...
            If dependencia = 276 And secretaria = 313 And puesto <> 4 Then
                Response.Redirect("~/Eventos2015/RequerimientosComunicacion.aspx")
            End If
    ...
    Protected Sub txtFolio_TextChanged(sender As Object, e As System.EventArgs) Handles txtFolio.TextChanged
        ...
        If Me.txtFolio.Text <> "" Then
            ...
            Else
                ...
                Try
                    If dt.Rows(0)("validadoEnlaceAdmin") = False Then
                        'EL EVENTO ESTA LISTO PARA VALIDAR POR ENLACE ADMINISTRATIVO
                        btnValidarEvento.Enabled = True
                    ElseIf dt.Rows(0)("validadoEnlaceAdmin") = True Then
...
#End Region
    ...
    Protected Sub btnValidarEvento_Click(sender As Object, e As EventArgs)
        Dim helper As New IntelipolisEngine.Eventos.EventoHelper()
        helper.AgregaValidacionEvento(txtFolio.Text, Session("clave_empl"), 1)
        txtFolio_TextChanged(Nothing, Nothing)
