...
Public Class conexion
    ...
    Public Function Conectar() As SqlClient.SqlConnection
        ...
        con.ConnectionString = conexionServidor
        con.Open()
        Return con
    End Function
    ...
    Public Shared Function sqlcon(ByVal str As String) As DataTable   ' recibe una variable con el query
        ...
        Dim conexionServidor = "Data Source=187.176.54.246;Initial Catalog=Planeacion_Financiera;User ID=usrPlaneacion;Password=usrPlaneacion"
