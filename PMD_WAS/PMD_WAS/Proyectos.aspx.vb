...
Partial Class Proyectos
    ...
    Public Sub LineasProgramadas()
        ...
        stry = "select a.ID,a.Descr_estrategia,a.Secretaria,a.Unidad_Medida,b.Acumulado as Anual, " &
                 ...
                 "where a.Cve_admon='" & Me.DropAdmon.Text & "' and b.Año_P='" & Me.DropAño.Text & "' and a.Clasificacion='PROYECTO' and a.tipo_de_linea=1 "
    ...
    Public Sub LineasPorSolicitud()
        ...
        stry = "select a.ID,a.Descr_estrategia,a.Secretaria,a.Unidad_Medida,b.Acumulado as Anual, " &
                 ...
                 "where a.Cve_admon='" & Me.DropAdmon.Text & "' and b.Año_P='" & Me.DropAño.Text & "' and a.Clasificacion='PROYECTO' and a.tipo_de_linea=2 "
