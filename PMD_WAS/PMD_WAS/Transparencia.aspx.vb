...
Public Class Transparencia
    ...
    Public Sub LineasProgramadas()
        ...
        stry = "select distinct(dbo.fn_SplitString2(a.ID,'.'))as Digitos,a.ID," &
              "a.Eje,a.Objetivo,a.Estrategia,a.Linea,a.Sublinea," &
              ...
              "inner join Estrategias b on a.Estrategia=b.IdEstrategia  and a.Objetivo=b.IdObjetivo and a.Eje=b.IdEje  and a.Cve_admon=b.Admon " &
              "left join Informacion_Planeada c on a.ID=c.ID and a.Año=c.Año_P " &
              "left join Informacion_Real d on a.ID=d.ID  and c.Mes=d.Mes and c.Año_P=d.Año_R and c.Cve_admon=d.Cve_admon " &
        ...
        stry = stry & "order by a.Eje,a.Objetivo,a.Estrategia,a.Linea,a.Sublinea"
    ...
    Public Sub LineasPorSolicitud()
        ...
        stry = "select distinct(dbo.fn_SplitString2(a.ID,'.'))as Digitos,a.ID, " &
            "a.Eje,a.Objetivo,a.Estrategia,a.Linea,a.Sublinea," &
                ...
                "from Concentrado_PMD a " &
                "left join Informacion_Planeada c on a.ID=c.ID and a.Año=c.Año_P  and a.Cve_admon=c.Cve_admon " &
                "left join Informacion_Real d on c.ID=d.ID and c.Año_P =d.Año_R and c.Mes=d.Mes " &
                "left join Informacion_Solicitada e on d.ID=e.ID  and d.Mes=e.Mes and d.Año_R=e.Año " &
        ...
        End Select
        'el tipo de Linea es para las lineas programadas
        stry = stry & " and a.tipo_de_linea='2' order by a.Eje,a.Objetivo,a.Estrategia,a.Linea,a.Sublinea"
    ...
    Public Sub LlenarAdmon()
        ...
        Dim sent As New System.Data.SqlClient.SqlCommand("Select Cve_admon,Nombr_admon from Cat_Admon", conectar.conectar)
        Dim exe As System.Data.SqlClient.SqlDataReader
    ...
    Public Sub LlenaDropAño()
        'LLENAR EL DROP AÑOS
        Dim sent2 As New System.Data.SqlClient.SqlCommand("Select Año from Admin_meses where Admon='" & Me.DropAdmon.Text & "'", conectar.conectar)
    ...
    Private Sub LlenarObjetivos()
        ...
        Dim sent As New System.Data.SqlClient.SqlCommand("Select IdObjetivo,Nombr_obj from Objetivos where IdEje='" & Me.DropEje.SelectedValue & "' and Admon='" & Me.DropAdmon.SelectedValue & "'", conectar.conectar)
        Dim exe As System.Data.SqlClient.SqlDataReader
    ...
    Private Sub LLenarEstrategias()
        ...
        Dim sent As New System.Data.SqlClient.SqlCommand("Select IdEstrategia,Nombr_estr from Estrategias where IdObjetivo='" & Me.DropObj.SelectedValue & "' and IdEje='" & Me.DropEje.SelectedValue & "' and Admon='" & Me.DropAdmon.SelectedValue & "'", conectar.conectar)
        Dim exe As System.Data.SqlClient.SqlDataReader
    ...
    Private Sub LlenarLineas()
        ...
        Dim sent As New System.Data.SqlClient.SqlCommand("Select IdLinea,Nombr_linea from Lineas where IdEstrategia='" & Me.DropEstr.SelectedValue & "' and  IdObjetivo='" & Me.DropObj.SelectedValue & "' and IdEje='" & Me.DropEje.SelectedValue & "' and Admon='" & Me.DropAdmon.SelectedValue & "'", conectar.conectar)
        Dim exe As System.Data.SqlClient.SqlDataReader
    ...
    Public Sub LlenarEjes()
        'LLENAR DROP EJES
        Dim sent3 As New System.Data.SqlClient.SqlCommand("Select IdEje,Desc_eje from Ejes where Admon='" & Me.DropAdmon.SelectedValue & "'", conectar.conectar)
