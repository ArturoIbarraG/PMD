                        ...
                        <asp:GridView ID="grdPOA" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-bordered">
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Button ID="btnVer" runat="server" CssClass="btn btn-link" Style="font-size: 24px; font-weight: 600; padding: 0; margin: 0;" ToolTip="Ver las Sub actividades" Text="+" OnCommand="btnVer_Command" CommandName="ver" CommandArgument='<%# Eval("IdConcentrado") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Button ID="btnEditar" runat="server" CssClass="btn btn-link" Text="Editar" OnCommand="btnVer_Command" CommandArgument='<%# Eval("IdConcentrado") %>' CommandName="editar" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Button ID="btnAgregarSubactividad" runat="server" CssClass="btn btn-link" Style="font-size: 15px; font-weight: 600; padding: 0; margin: 0;" ToolTip="Agregar nueva Sub actividad" OnCommand="btnVer_Command" Text="Nueva Sub actividades" CommandName="add" CommandArgument='<%# String.Format("{0}|{1}", Eval("idActividad"), Eval("IdConcentrado")) %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="9">
                                                <asp:GridView ID="grdSubActividades" runat="server" CssClass="table table-striped table-small table-detail" Width="100%" Visible="false" AutoGenerateColumns="false">
                                                    <Columns>
                                                        <asp:BoundField HeaderText="Actividad" DataField="Id_Linea" />
                                                        <asp:BoundField HeaderText="Sub actividad" DataField="Id_Subactividad" />
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <asp:DropDownList ID="ddlDireccionModal" runat="server" CssClass="form-control select-basic-simple" AutoPostBack="true" OnSelectedIndexChanged="ddlDireccionModal_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <h6 class="subtitle">Programa:</h6>
                                        <asp:DropDownList ID="ddlProgramaModal" runat="server" AutoPostBack="true" CssClass="form-control select-basic-simple" OnSelectedIndexChanged="ddlProgramaModal_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <h6 class="subtitle">Componentes:</h6>
                                        <asp:DropDownList ID="ddlComponenteModal" runat="server" AutoPostBack="true" CssClass="form-control select-basic-simple" OnSelectedIndexChanged="ddlComponente_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 col-md-6">
