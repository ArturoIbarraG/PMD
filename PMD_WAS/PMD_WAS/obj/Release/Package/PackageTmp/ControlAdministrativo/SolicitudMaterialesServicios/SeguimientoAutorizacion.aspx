<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterNuevaImagen.Master" CodeBehind="SeguimientoAutorizacion.aspx.vb" Inherits="PMD_WAS.SeguimientoAutorizacion" %>
    ...
    <asp:UpdatePanel ID="updRequisiciones" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
             ...
             <asp:Button ID="btnAutorizarOrdenesSurtido" runat="server" CssClass="btn btn-primary" Text="Autorizar" OnClick="btnAutorizarOrdenesSurtido_Click" />
                </div>
            </div>
            <div class="row">
                <div class="col-12">
