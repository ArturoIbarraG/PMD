<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucPresupuestoDireccionGrafico.ascx.vb" Inherits="PMD_WAS.ucPresupuestoDireccionGrafico" %>
   <style type="text/css">
        .enlaceAnterior {
            cursor: pointer;
...
<div class="container-fluid">
    ...
    <asp:HiddenField ID="hdnSecretariaUserControlPresupuesto" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hdnDireccionUserControlPresupuesto" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hdnAnioUserControlPresupuesto" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hdnNombreDireccionUserControlPresupuesto" runat="server" ClientIDMode="Static" />
</div>
<script type="text/javascript">
    function muestraGraficoPresupuesto() {
        $('#enlaceRegresarAnterior').text('Desglose de Presupuesto de ' + $('#hdnNombreDireccionUserControlPresupuesto').val());

        var urlPresupuesto = '<%= ResolveClientUrl("~/WSEventos.asmx/ObtienePresupuestoDireccionGrafico") %>';
        var secretaria = $('#hdnSecretariaUserControlPresupuesto').val();
        var direccion = $('#hdnDireccionUserControlPresupuesto').val();
        var anio = $('#hdnAnioUserControlPresupuesto').val();
