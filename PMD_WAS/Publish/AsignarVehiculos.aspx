<%@ Page Language="VB" Title="Asignación de Vehiculos" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterNuevaImagen.master" Inherits="PMD_WAS.AsignarVehiculos" Codebehind="AsignarVehiculos.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="updAsignacionVehiculo" runat="server">
        <ContentTemplate>
            <div class="container">
                <div class="row">
                ...
                <div id="panelAsignacion" class="row">
                    <div class="col-12">
                        ...
                        <asp:Panel ID="pnlAsignacionRecursos" runat="server" Visible="false">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <asp:DropDownList ID="ddlTipoAsignacion" runat="server" AutoPostBack="true" CssClass="form-control select-basic-simple" OnSelectedIndexChanged="ddlTipoAsignacion_SelectedIndexChanged">
                                            <asp:ListItem Text="Por vehiculo" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Por tipo de uso" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-4">
                                        ...
                                        <asp:DropDownList ID="ddlElementoAsignar" runat="server" AutoPostBack="true" CssClass="form-control select-basic-simple" OnSelectedIndexChanged="ddlElementoAsignar_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                    <div class="col-4">
                                        <p style="font-size: medium; visibility: hidden;">Frecuencia de asignación</p>
                                        <button class="btn  btn-secondary" data-target="#modalAgregarVehiculo" data-toggle="modal">Solicitar vehiculo</button>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
                            ...
                            <asp:Repeater ID="rptVehiculoSubActividad" runat="server" OnItemDataBound="rptVehiculoSubActividad_ItemDataBound">
                                <ItemTemplate>
                                    <br />
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <asp:Panel ID="pnlMensual" runat="server">
                                                    <table width="100%" class="table table-sm table-hover table-bordered table-asignacion">
                                                        ...
                                                        <asp:Repeater ID="rptSubActividadesMeses" runat="server" OnItemDataBound="rptSubActividadesMeses_ItemDataBound">
                                                            <ItemTemplate>
    ...
    <div id="modalAgregarVehiculo" class="modal fade modal-medium" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">Solicitar Vehiculo</h2>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <asp:UpdatePanel ID="updAgregaVehiculo" runat="server">
                        <ContentTemplate>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-4">
                                        <p>Tipo uso</p>
                                        <asp:DropDownList ID="ddlTipoUsoAgregar" runat="server" Width="100%" CssClass="form-control select-basic-simple">
                                            <asp:ListItem Text="Administrativo" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Operativo" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-4">
                                        <p>Cantidad</p>
                                        <asp:TextBox ID="txtCantidadVehiculos" runat="server" Width="100%" onkeypress="javascript:validaNumeros(this, event);"></asp:TextBox>
                                    </div>
                                    <div class="col-4">
                                        <p style="visibility: hidden;">Puesto</p>
                                        <asp:Button ID="btnAgregaVehiculo" runat="server" data-validador="0" CssClass="btn  btn-secondary" Text="Solicitar" OnClick="btnAgregaVehiculo_Click" />
                                    </div>
                                </div>
                            </div>
                        </ContentTemplate>
