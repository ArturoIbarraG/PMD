<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" Inherits="PMD_WAS.ConsultaEje" Codebehind="ConsultaEje.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="margin: -4% 20% 2% 20%; text-align: center;">
        <asp:Label ID="lbltitulo" runat="server" Font-Bold="True" Font-Size="25pt" Text="Consulta De Ejes"></asp:Label>
        <blockquote>
                        ...
                        <asp:GridView ID="GridEje" runat="server" AutoGenerateColumns="false" Width="100%">
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                    <asp:Label ID="CveL" runat="server" Width="20px" Text='<%#Eval ("IdEje") %>'></asp:Label>
                                        <asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval ("Desc_eje") %>' Width="90%" style="/*display:inline-block; */font-family:Candara;"
                                            CommandName="Buscar" CommandArgument='<%# Eval("IdEje") %>' CssClass="Links"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        ...
                        <asp:GridView ID="GridObj" runat="server" AutoGenerateColumns="false" Width="100%">
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval ("Nombr_obj") %>' Width="90%" style="font-family:Candara;"
                                            CommandName="Buscar" CommandArgument='<%# Eval("IdObjetivo") %>' CssClass=" Links"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        ...
                        <asp:GridView ID="GridEstr" runat="server" AutoGenerateColumns="false" Width="100%">
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval ("Nombr_estr") %>' style="font-family:Candara;"
                        ...
                        <asp:GridView ID="GridLin" runat="server" AutoGenerateColumns="false" Width="100%">
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                    <asp:Label ID="CveL" runat="server" Width="20px" Text='<%#Eval ("IdLinea") %>'></asp:Label>
                                        <asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval ("Nombr_linea") %>' style="font-family:Candara;"
                                            Width="189px" CommandName="Buscar" CommandArgument='<%# Eval("IdLinea") %>' CssClass="Lin"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        ...
                        <asp:GridView ID="GridSubL" runat="server" AutoGenerateColumns="false" Width="100%">
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                    <asp:Label ID="CveL" runat="server" Width="20px" Text='<%#Eval ("IdSublinea") %>'></asp:Label>
                                        <asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval ("Nombr_Sub") %>' Width="189px" style="font-family:Candara;"
