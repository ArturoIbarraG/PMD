<%@ Page Language="VB" AutoEventWireup="false" Inherits="PMD_WAS.Login2" Codebehind="Login2.aspx.vb" %>
...
<body>   
    ...
    <div id="Master_Div">
    <div id="Div_Imagen">
    <%-- <img src="imagenes/Bisonte.jpg" width="100%" height="100%"/>--%>
    </div>
   ...
   <%--<img src="images/logosannicolas.png" width="100%" height="100%"/>--%>
    ...
    <ContentTemplate>
    <div id="Div_Usuario">
    <asp:TextBox ID="Txt_Usuario" Height="80%" Width="100%" placeholder="Usuario" Font-Size="Large" runat="server" onkeypress="javascript:return solonumeros(event)"></asp:TextBox>
    </div>
    ...
    <div id="Div_Btn_Aceptar"> 
        <asp:Button ID="Button1" CssClass="button" runat="server" width= "55px" Text="Entrar" OnClientClick="OpenPopupx();" />
    </div>
    </ContentTemplate>
    </asp:UpdatePanel>
    <div id="Div_Info">
