<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" Inherits="PMD_WAS.Transparencia" Codebehind="Transparencia.aspx.vb" %>
        ...
        <ContentTemplate>
            ...
            <div id="DivRadio1" style="margin: 0% 5% 0% 28%; text-align: left; float: left; font-size: 18px;
                ...
                <asp:RadioButtonList runat="server" RepeatDirection="Vertical" ID="Radio1" AutoPostBack="True">
                    <asp:ListItem Selected="True">Ejes</asp:ListItem>
            ...
            <asp:UpdatePanel ID="UpdatePanelEje" runat="server" style="margin: 3% 0% 0% 15%;">
                <ContentTemplate>
                    <div id="DivEje" style="margin: 0px 20px 0px 102px; text-align: left; font-size: medium;">
                        Eje:
                        <asp:DropDownList ID="DropEje" runat="server" Width="340px" AutoPostBack="True">
                        </asp:DropDownList>
                    ...
                    <div id="DivObj" style="margin: 0px 20px 0px 57px; text-align: left; font-size: medium;">
                        Objetivos:
                        <asp:DropDownList ID="DropObj" runat="server" Width="250px" AutoPostBack="True">
                        </asp:DropDownList>
                    ...
                    <div id="DivEstrategia" style="margin: 0px 20px 0px 54px; text-align: left; font-size: medium;">
                        Estrategia:
                        <asp:DropDownList ID="DropEstr" runat="server" Width="250px" AutoPostBack="True">
                        </asp:DropDownList>
                    ...
                    <div id="DivLínea" style="margin: 0px 20px 0px 85px; text-align: left; font-size: medium;">
                        Línea:
                        <asp:DropDownList ID="DropLinea" runat="server" Width="500px" AutoPostBack="True">
                        </asp:DropDownList>
                        <asp:CheckBox ID="CheckLinea" runat="server" AutoPostBack="True" Text="TODAS" />
                    </div>
                    <div id="DivSublínea" style="margin: 0px 20px 0px 60px; text-align: left; font-size: medium;">
                        SubLínea:
                        <asp:DropDownList ID="DropSublinea" runat="server" Width="500px" AutoPostBack="True">
                        </asp:DropDownList>
                        <asp:CheckBox ID="CheckSubL" runat="server" AutoPostBack="True" Text="TODAS" />
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblDescripcion" runat="server" Font-Size="8" 
                                                Text='<%# Eval("Descr") %>' Width="170"></asp:Label>
                                        </td>
                                        <td align="center">
                                        ...
                                        <td align="center">
                                            <asp:Label ID="Label2" runat="server"
                                                Text='<%# Eval("Dirección") %>' Width="120"></asp:Label>
                                        </td>
                                        <td width="50">
                                            <asp:Label ID="Label8" runat="server" Font-Size="8" 
                                                Text='<%# Eval("Clasificación") %>' Width="70"></asp:Label>
                                        </td>
                                      
                                        <td width="43">
                                             <asp:Label ID="Label10" runat="server" Font-Size="8" 
                                                Text='<%# Eval("Unidad_Medida") %>' Width="80"></asp:Label>
                                        </td>
                                        <td width="43">
                                           <asp:Label ID="Label12" runat="server" Font-Size="8" 
                                                Text='<%# Eval("Planeado") %>' Width="80"></asp:Label>
                                        </td>
                                        <td width="43">
                                            <asp:Label ID="Label14" runat="server" Font-Size="8" 
                                                Text='<%# Eval("Real") %>' Width="80"></asp:Label>
                                        </td>
                                      
                                        <td width="43">
                                            <asp:Label ID="Label15" runat="server" Font-Size="8" 
                                                Text='<%# Eval("Comentarios") %>' Width="220"></asp:Label>
                                        </td>
                            ...
                            <ItemTemplate>
                                <table>
                                    <tr>
                                        ...
                                        <td width="43">
                                           <asp:Label ID="Label12" runat="server" Font-Size="8" 
                                                Text='<%# Eval("PorcentajePlaneado") %>' Width="80"></asp:Label>
                                        </td>
                                        <td width="43">
                                            <asp:Label ID="Label14" runat="server" Font-Size="8" 
                                                Text='<%# Eval("PorcentajeReal") %>' Width="80"></asp:Label>
                                        </td>
